import { HStack, Image, Text, VStack, Icon, Box, Spinner } from '@chakra-ui/react';
    ...
    return (
        ...
        >
            <HStack
                ...
                zIndex="1"
            >
                <VStack w="3rem" minW="3rem" h="5rem" mr="0.5rem"
                    justifyContent={"center"}
                    alignItems={'center'}>
                    <Spinner display={player.ready ? "none" : "block"} color="brand.600" speed={'1.5s'} />
                    <Icon
                        alignSelf={'center'}
                ...
                <VStack w="5rem" minW="5rem" h="5rem" mr="0rem"
                    bgColor="gray.1000"
                    justifyContent={"center"}
                    alignItems={'center'}>
                    <Text as="span"
