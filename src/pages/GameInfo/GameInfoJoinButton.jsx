...
import { btGame, btJoinButtonVisible, btQueues } from "../../actions/buckets";
...
function GameInfoJoinButton(props) {
    ...
    return (
        <VStack ref={ref} w="100%" mt="1rem" alignItems={["center", "center", "center"]}>
...
function JoinButton({ handleJoin }) {
    ...
    if (queue.game_slug) {
        return <Searching isHeader={true} />;
    }
    return (
        <Button
            role="group"
            onClick={() => {
                if (queue.game_slug) return;
                handleJoin();
            }}
        ...
        >
            <VStack spacing="0" alignItems={"flex-start"}>
                <Text
                    as="span"
                    textAlign={"left"}
                    fontSize={["1.6rem", "1.6rem", "1.6rem", "2rem"]}
                >
