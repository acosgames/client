import { Box, HStack, Heading, Text, VStack, Image, Card, CardBody } from "@chakra-ui/react";
...
export default function GameStats({}) {
    ...
    let player_stat = useBucketSelector(btPlayerStats, (bucket) => bucket[game.game_slug]);
