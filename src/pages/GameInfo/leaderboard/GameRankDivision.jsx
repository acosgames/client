...
import { btDivision, btGame, btLoading, btUser } from "../../../actions/buckets";
import { useBucket, useBucketSelector } from "../../../actions/bucket";
import { useEffect } from "react";
import { findGameRankDivision, findGameRankGlobal } from "../../../actions/game";
...
export default function GameRankDivision({ game_slug }) {
    ...
    useEffect(() => {
        let game = btGame.get();
        if (game_slug && game.division_id) findGameRankDivision(game_slug, game.division_id);
    }, [game_slug]);
