...
import FSGRead from "../../../../components/widgets/inputs/FSGRead";
...
function GameInfo2(props) {
    ...
    if (game.minplayers == game.maxplayers) playerCntRange = game.minplayers;
...
function GameInfoLoading(props) {
    if (props.loadingGameInfo) return <></>;
    // return (<Text fontSize="4xl" color={'#D9E63A'}>Loading</Text>)
    return <Text fontSize="4xl">404: Game Not Found</Text>;
}
