...
import FSGCopyText from "../../../components/widgets/inputs/FSGCopyText";
...
function DevMyGameListItem(props) {
    ...
    const onApproveDeploy = async (e) => {
        let deployedGame = await deployToProduction({
            gameid: props.gameid,
            latest_version: props.latest_version,
        });
        if (!deployedGame) {
            toast({
        ...
        toast({
            ...
            description:
                "The game version will be propagate in about one (1) hour.",
            status: "success",
            duration: 30000,
            isClosable: true,
        });
            ...
            <Flex>
                <Wrap align="stretch" flexGrow={1}>
                    <Flex justifyItems={["left", "left"]}>
                        ...
                        <VStack align="stretch" pl="0.5rem">
                            <Box>
                                <Link to={"/dev/game/" + props.gameid}>
                                    <Text
                                        pl={["1rem", "1rem", "0", "0"]}
                        ...
                        >
                            <AlertDialogOverlay>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogBody>
                                        Are you sure? <br />
                                        Make sure there are no bugs in your
                                        game!
                                    </AlertDialogBody>
