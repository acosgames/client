...
import FSGButton from "../../../components/widgets/inputs/FSGButton.js.jsx";
...
function DevManageGameFields(props) {
    ...
    const onUpdateVersion = async (e) => {
        ...
        if (value < 0 || value > props.devgame.latest_version) return false;
    ...
    const onUpdateVisibility = async (e) => {
        ...
        if (!Number.isInteger(value)) return false;
        if (value < 0 || value > props.devgame.version) return false;
            ...
            <FSGGroup hfontSize="md" title="Publishing">
                <HStack align="left">
                    <Wrap
                        ...
                        spacing="2rem"
                        display={
                            props.devgame.latest_version > 0 ? "flex" : "none"
                        }
                    >
                        <Wrap>
                        ...
                        <Wrap>
                            ...
                            <Text fontWeight="bold">
                                v{props.devgame.latest_version}
                            </Text>
                        </Wrap>
                        <Wrap
                            color="gray.200"
