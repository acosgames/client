        ...
        <VStack justifyContent={'center'}>
            <Box className={'statictext'}>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to "A cup of skill".</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to A cup of skill, accessible from <a href="https://acos.games" rel="external nofollow noopener" target="_blank">https://acos.games</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: admin@acos.games</li>
                </ul>
            </Box>
        </VStack>
    )
