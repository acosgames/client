...
import FSGSubmit from "../../components/widgets/inputs/FSGSubmit.jsx"; //" widgets/inputs/FSGSubmit";
...
export default function GameInfoCreateDisplayname({ onClose, isOpen, onOpen }) {
    ...
    let displayname = useBucketSelector(
        btFormFields,
        (form) => form["createplayer"]?.name
    );
    ...
    const generateName = () => {
        ...
        btFormFields.assign({ createplayer: { name: nameParts.join("") } });
    ...
    const onChange = (e) => {
        ...
        updateGameField(name, value, "createplayer");
                            ...
                            >
                                ...
                                <FSGSubmit
                                    _hover={{
                                        ...
                                        boxShadow:
                                            "7px 3px 0 var(--chakra-colors-brand-300)",
                                        // bgColor: 'brand.300',
                                    }}
                                    _focus={{
                                        // border: "4px solid",
