...
export default function ChooseCountry({ bgColor }) {
    let countryChanged = useBucket(btCountryChanged);
    let defaultCountry = useBucket(btDefaultCountry);
    let user = btUser.get() || {};

    defaultCountry = user?.countrycode || defaultCountry;
    ...
    if (!defaultCountry) {
        ...
        defaultCountry =
            cc2.find((cntry) => cntry.value == defaultCountry) || cc2[0];
    }
