...
import { IoExitOutline, IoHammer } from "react-icons/io5";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <HStack py="1rem" spacing="0rem" width="100%" justifyContent={"center"}>
          <Icon
            as={BsBarChartFill}
            size="1.6rem"
            mr="0.5rem"
      ...
      >
        ...
        >
          <MenuItem
            ...
            py="1rem"
          >
            <Icon as={ImUser} mr="1.5rem" fontSize="2rem" />
            Profile
          </MenuItem>
        </Link>
        <MenuDivider color="gray.500" />
...
export default fs.connect(["user", "latency", "wsConnected", "duplicatetabs"])(
  NavForUser
);
