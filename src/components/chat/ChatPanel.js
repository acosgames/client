...
function ChatPanel(props) {
    ...
    return (
        <Box
            ...
            width={isBottomLayout ? '100%' : !toggle ? '0' : ['28.0rem', '28rem', '28.0rem']}
...
function ChatMessages(props) {
    ...
    let maxHeight = !props.isBottomLayout ? "100%" : (props.toggle ? '23rem' : '0');
    const ChakraSimpleBar = chakra(SimpleBar)

    return (
        <VStack width="100%" height={props.expanded ? "auto" : '0'} maxHeight={props.isBottomLayout ? "20rem" : ''} boxSizing='border-box' overflow='hidden' flex={props.expanded ? "1" : ''} spacing="0">
            <ChakraSimpleBar
